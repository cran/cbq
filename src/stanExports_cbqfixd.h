...
namespace model_cbqfixd_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_cbqfixd");
    reader.add_event(137, 135, "end", "model_cbqfixd");
    return reader;
}
...
class model_cbqfixd : public prob_grad {
private:
        int N;
        int D_common;
        vector_d Y;
...
public:
    model_cbqfixd(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_cbqfixd_namespace::model_cbqfixd";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_cbqfixd_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_cbqfixd_namespace::model_cbqfixd stan_model;
#endif
